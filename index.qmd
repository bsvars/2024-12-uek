...
## <span style='color: #ff68b4;'>Część pierwsza</span> {background-color="#77001b"}
...
## <span style='color: #ff68b4;'>Część druga</span> {background-color="#77001b"}
...
## <span style='color: #ff68b4;'>materiały</span> {background-color="#77001b"} 
...
## <span style="color: #ff68b4;">cechy paczek bsvars i bsvarSIGNs</span> {background-color="#77001b"}
...
## <span style="color: #ff68b4;">strukturalne modele VAR</span> {background-color="#77001b"}
...
## <span style="color: #ff68b4;">identyfikacja modeli strukturalnych</span>  {background-color="#77001b"}
...
- $\mathbf{B}$ <text style="color:#77001b;">**nie jest indentyfikowalna**</text>
...
## <span style='color: #ff68b4;'>modelowanie rozkładu i zmienności</span> {background-color="#77001b"}
...
![](social_uek.png){.absolute top=10 right=10 width="1000"}
...
## <span style='color: #ff68b4;'>Australian Monetary Policy Analysis</span> {background-color="#77001b"}
